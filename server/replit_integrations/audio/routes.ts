...
import { openai, speechToText, voiceChatWithTextModel, textToSpeechStream } from "./client";
...
export function registerAudioRoutes(app: Express): void {
  ...
  // Simple TTS endpoint for verbatim reading
  app.post("/api/audio/tts", async (req: Request, res: Response) => {
    try {
      ...
      for await (const chunk of await textToSpeechStream(text, voice)) {
