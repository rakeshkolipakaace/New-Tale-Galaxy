...
//   const startExplainRef = useRef<(() => void) | null>(null);
...
//     console.log(`Starting explain mode on page ${currentPage + 1} of ${story.pages.length}`);
...
//           console.log(`Advancing to page ${nextPage + 1} of ${story.pages.length}`);
//           setCurrentPage(nextPage);
//           setCurrentWordIndex(-1);
//           setHighlightedWords(new Set());

//           // Small delay before starting next page to let the UI update
//           setTimeout(() => {
//             if (modeRef.current === "explain" && startExplainRef.current) {
//               // Clear any existing interval before starting next page
//               if (explainIntervalRef.current) {
//                 clearInterval(explainIntervalRef.current);
//               }
//               console.log(`Starting explain on page ${nextPage + 1}`);
//               startExplainRef.current();
//             }
//           }, 1000); // Increased delay to ensure page data is updated
//         } else {
//           console.log('Reached last page, stopping explain mode');
//           setMode("idle");
//           modeRef.current = "idle";
//           setCurrentWordIndex(-1);
//         }
...
//       language: "en-US",
//       onDone: () => {
//         // Don't stop here - let the interval handle auto-advance
//         // The interval will handle page advancement and stopping at the end
//       },
//       onStopped: () => {
//         if (explainIntervalRef.current) clearInterval(explainIntervalRef.current);
//       },
...
//   useEffect(() => {
//     startExplainRef.current = startExplain;
//   }, [startExplain]);
...
//       // Auto-advance to next page if current page is finished
//       if (storyIdx >= storyWordsNorm.length && storyWordsNorm.length > 0) {
//         if (currentPageRef.current < story.pages.length - 1) {
//           const nextPage = currentPageRef.current + 1;

//           // Small delay to let user see highlights before switching
//           setTimeout(() => {
...
//             {/* Page Navigation is now integrated into bottom bar */}
//           </View>
//         </View>
//       </ScrollView>
